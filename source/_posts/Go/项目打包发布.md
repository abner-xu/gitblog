...
RUN         go mod download
```
![](http://ww2.sinaimg.cn/large/aaba1596ly1g35sornlfqj20j70fl0ub.jpg)
...
### 阿里云加速翻墙速度
1、创建镜像仓库
![](http://ww2.sinaimg.cn/large/aaba1596ly1g35tf5x503j20t10rb770.jpg)
2、填写仓库信息
![](http://ww2.sinaimg.cn/large/aaba1596ly1g35tf5x503j20t10rb770.jpg)
3、选择仓库`管理`，进行配置仓库
4、选择git仓库版本，这里本人是放在github上，所以选择github，进行授权，选择自己的仓库和项目，配置如下具体dockerfile文件根据自己仓库路径配置
![](http://ww2.sinaimg.cn/large/aaba1596ly1g35tiibz9wj20zb0l90uz.jpg)
5、选择构建即可
