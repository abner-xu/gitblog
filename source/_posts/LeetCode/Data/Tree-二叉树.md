...
- 节点的层数=节点的深度+1
- 树的高度=根节点的高度
![1_2.png](http://ws1.sinaimg.cn/large/007lnJOlgy1ga1uba1bpdj30aj07174d.jpg)
...
![8.png](http://ww1.sinaimg.cn/large/007lnJOlgy1g9zt0dhr6lj30j80a8di4.jpg)

需要确定后继节点没有子节点，如果后继节点存在子节点，分情况讨论

- 后继节点是删除节点的右子节点

![9.png](http://ww1.sinaimg.cn/large/007lnJOlgy1g9zt3ex5jgj30e5099q4w.jpg)

- 后继节点是删除节点的右子节点的左子节点

![10.png](http://ww1.sinaimg.cn/large/007lnJOlgy1g9zt3eznt2j30fk0a6gnn.jpg)
...
func (this *BinaryTree) LevelOrder() [][]int {
	...
	for len(queue) > 0 {
		...
		for len(queue) > 0 {
			first := queue[0]
			queue = queue[1:]
			tmpValueList = append(tmpValueList, first.Value)
			if first.Left != nil {
